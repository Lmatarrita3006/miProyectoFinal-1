...
while True:
    rol = int(input("Digite 1 si desea ingresar a la plataforma de cliente, un 2 si desea ingresar a la plataforma de cocina y un 3 si desea salir del programa "))
    if rol == 2:
        ...
        print("\nGracias por visitar STEAM CENTER. ¡Hasta la próxima!")
        break
